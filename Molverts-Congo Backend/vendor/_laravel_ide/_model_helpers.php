...
namespace App\Models {
     ...
     * App\Models\Molecule
     *
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Plante> $plantes
     * @property-read int|null $plantes_count
     * @method static \Illuminate\Database\Eloquent\Builder<Molecule>|Molecule newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Molecule>|Molecule newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Molecule>|Molecule query()
     ...
     */
    class Molecule extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * App\Models\Plante
     *
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Molecule> $molecules
     * @property-read int|null $molecules_count
     * @method static \Illuminate\Database\Eloquent\Builder<Plante>|Plante newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Plante>|Plante newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Plante>|Plante query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
